...
var Player = function() {
    ...
    this.scores = 1; // score of the player
...
Player.prototype.render = function() {
    ...
    ctx.font = '30px Arial';
    ctx.fillStyle = '#fff';
    ctx.fillText('Score: ' + this.scores, 20, 581);

    // Draw player's collectible items and Lives
    ctx.fillText('Items: ' + this.itemCount, 360, 581);
    ctx.fillText('Lives: ' + this.lives, 200, 581);
};
